...
def main(qa_file, query_file, output_file):
    ...
    if os.path.exists(output_file):
        # Load existing file to get the current rows
...
# Main
if __name__ == "__main__":
    qa_file = '../Dataset/DataExcel/newStackExchangeQsAnswer/stackExchangeQsAndAnswersDB.xlsx'   # question-answer file passed to the model
    query_file = '../Dataset/DataExcel/newStackExchangeQsAnswer/stackExchangeQsAndAnswersTest.xlsx' # for extracting relevant context from the database
    output_file = 'updated_stackexchange_results.xlsx'   # updated dataset is stored here
